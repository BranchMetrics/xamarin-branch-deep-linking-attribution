package md5e2b59ee07bf870286f7f1b377c2633da;


public class BranchAndroidLifeCycleHandler
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("BranchXamarinSDK.BranchAndroidLifeCycleHandler, Branch-Xamarin-SDK.Droid, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", BranchAndroidLifeCycleHandler.class, __md_methods);
	}


	public BranchAndroidLifeCycleHandler () throws java.lang.Throwable
	{
		super ();
		if (getClass () == BranchAndroidLifeCycleHandler.class)
			mono.android.TypeManager.Activate ("BranchXamarinSDK.BranchAndroidLifeCycleHandler, Branch-Xamarin-SDK.Droid, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", "", this, new java.lang.Object[] {  });
	}
