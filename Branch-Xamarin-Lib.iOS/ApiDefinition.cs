...
namespace IOSNativeBranch {
    ...
    interface BranchQRCode
    {
        ...
        [Export("centerLogo", ArgumentSemantic.Copy)]
        ...
        [Export("pattern", ArgumentSemantic.Assign)]
        BranchQRCodePattern Pattern { get; set; }

        // @property (nonatomic, assign, readwrite) BranchQRCodeFinderPattern finderPattern;
        [Export("finderPattern", ArgumentSemantic.Assign)]
        BranchQRCodeFinderPattern FinderPattern { get; set; }

        // @property (nonatomic, strong, readwrite) UIColor *finderPatternColor;
        [Export("finderPatternColor", ArgumentSemantic.Strong)]
        UIColor FinderPatternColor { get; set; }
        ...
        [Export("backgroundImageOpacity", ArgumentSemantic.Copy)]
        NSNumber BackgroundImageOpacity { get; set; }

        // @property (nonatomic, copy, readwrite) NSString *patternImage;
        [Export("patternImage", ArgumentSemantic.Copy)]
        string PatternImage { get; set; }
